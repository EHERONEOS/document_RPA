...
SI_VERIFY_FIELDS = (
    *SI_BASE_FILL_FIELDS,
    ...
    ("input", "#pr_name", "receiptPlace", "收货地", True, True),
    ("input", "#pol_name", "pol", "起运港", True, True),
    ("input", "#pod_name", "pod", "目的港", True, True),
    ("input", "#pl_name", "deliveryPlace", "交付地", True, True),
    ("input", "#fd_name", "finalDestination", "最终目的地", True, True),
